    ...
    <Teleport to="body">
      ...
      >
        ...
        <div class="mt-1 border-t border-gray-100 pt-1 dark:border-gray-700">
          <button
            class="w-full flex items-center gap-2 px-4 py-2 text-sm transition-colors hover:bg-gray-100/50 dark:hover:bg-gray-700/50 disabled:cursor-not-allowed disabled:opacity-45"

...
function createDataProvider(deps) {
    ...
    return {
        ...
        // ========== 雨落成诗 ==========
        getYuluStatus: (ref) => callWorkerApi(resolveAccountId(ref), 'getYuluStatus'),
        ...
        useYuluItem: (ref, itemId, hostGid, landIds, options) => callWorkerApi(
        ...
        claimYuluResearch: (ref, nodeId) => callWorkerApi(resolveAccountId(ref), 'claimYuluResearch', nodeId),
        exchangeYuluBottle: (ref) => callWorkerApi(resolveAccountId(ref), 'exchangeYuluBottle'),
